...
const DropdownButton: React.FC<DropdownButtonProps> = ({
  ...
  return (
    <div>
      <button type="button" className="flex items-center w-full p-2 text-base text-gray-900 transition duration-75 rounded-lg group hover:bg-gray-100 dark:text-gray-200 dark:hover:bg-gray-700" onClick={toggleDropdown}>
        ...
        <span className="flex-1 ml-3 text-left whitespace-nowrap" sidebar-toggle-item="">{buttonText}</span>
