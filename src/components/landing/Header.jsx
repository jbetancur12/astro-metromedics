...
export default function Header() {
  ...
  return (
    <nav
      id='header'
      class='fixed w-full z-30 top-0 text-white border-y-green-500 border-t-6 bg-black'
    >
      <div
      ...
      >
        <div class='pl-4 flex items-center'>
          <a
            ...
            href='/'
          >
            <img class='max-w-[200px] md:max-w-fu mx-auto h-auto' src='/images/logo-1.png' alt='Logo' />
          </a>
        </div>
        ...
        >
          <ul
            class='list-reset lg:flex justify-end flex-1 items-center text-2xl'
          >
            <li class='mr-3'>
              <a
            ...
            <li class='mr-3'>
              <a
                ...
                class: list={[Astro.url.pathname == "/servicios" && "text-green-500 font-bold"]}
            ...
            <li class='mr-3'>
              <a
                class='inline-block text-white no-underline hover:text-green-500 hover:text-underline py-2 px-4'
                class: list={[Astro.url.pathname == "/contacto" && "text-green-500 font-bold"]}
